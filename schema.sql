-- Django Project Schema for PostgreSQL
...
--
CREATE TABLE "django_content_type" ("id" SERIAL PRIMARY KEY, "name" varchar(100) NOT NULL, "app_label" varchar(100) NOT NULL, "model" varchar(100) NOT NULL);
CREATE UNIQUE INDEX "django_content_type_app_label_model_76bd3d3b_uniq" ON "django_content_type" ("app_label", "model");

--
-- Create model Group and Permission (from auth app)
--
...
--
-- Create M2M table for Group and Permission
--
...
--
-- Create M2M tables for SocialEntity
--
...
--
-- Create model LogEntry (from admin app)
--
...
--
-- Create models from mercadosorcery app
--
...
CREATE TABLE "mercadosorcery_colecao" ("id" SERIAL PRIMARY KEY);
CREATE TABLE "mercadosorcery_lista" ("id" SERIAL PRIMARY KEY, "nome" varchar(100) NOT NULL);
CREATE TABLE "mercadosorcery_posse" ("id" SERIAL PRIMARY KEY, "estado_carta" varchar(2) NOT NULL, "status" varchar(20) NOT NULL, "preco_usd" NUMERIC NULL);
